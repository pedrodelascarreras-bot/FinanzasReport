...
function renderLogoRulesTab(rules){
  ...
  html += '<div style="padding:14px;background:#f8f8fc;border-radius:16px;border:1px solid var(--border);margin-bottom:12px;">'
    ...
    +'<div style="display:flex;gap:8px;flex-wrap:wrap;align-items:flex-end;margin-bottom:10px;">'
      +'<div style="flex:1;min-width:110px;"><div style="font-size:9.5px;color:var(--text3);margin-bottom:4px;font-weight:700;text-transform:uppercase;">Detectar</div><input id="logo-rule-keyword" type="text" placeholder="ej: MERPAGO o RAPPI" title="La regla matchea cualquier movimiento que CONTENGA esta palabra. Ej: MERPAGO matchea MERPAGO*TAURA, MERPAGO*KIOSCO, etc." style="width:100%;padding:10px 12px;border:1px solid var(--border);border-radius:12px;background:#fff;color:var(--text);font-size:12.6px;font-family:var(--font);"></div>'
